      ...
      items: [
        "The bot posts new items to channels that have a feed configured and, if you opt in, sends you a DM when a new item is published.",
        {
          ...
          rows: [
            ...
            ["<code class=\"cmd-chip\">/about</code>", "Show what the bot is about and information about the project"],
      ...
      items: [
        "These are the channel permissions the bot requests in a server, and how they are used:",
        {
          ...
          rows: [
            ...
            ["<strong>Use Slash Commands</strong>", "Invoke the command interface", "All bot commands are slash commands (/latest, /top, /about, /notify ..., /delete, /help) and need this permission to run"],
